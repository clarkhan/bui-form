var $ = require('jquery'),
  ...
  Form = require('../index');
  TextField = require('../src/fields/text'),
  TextAreaField = require('../src/fields/textarea'),
  NumberField = require('../src/fields/number');

//文本域
describe('测试textfield', function(){
...
//文本域测试方法事件
describe('测试textfield方法', function(){
  var tpl = ' <label class="control-label">{label}</label>\
                <div class="controls">\
                </div>';
...
describe('测试textareafield', function(){
  var tpl = ' <label class="control-label">{label}</label>\
                <div class="controls">\
                </div>';
...
//数字域
describe('测试numberfield', function(){
  var tpl = ' <label class="control-label">{label}</label>\
              <div class="controls">\
              </div>';
  var msg = '不能大于200！',
...
//单独显示文本，不允许编辑可以格式化
describe('单独显示文本，不允许编辑可以格式化', function(){
  var tpl = ' <label class="control-label">{label}</label>\
              <div class="controls">\
              </div>',
