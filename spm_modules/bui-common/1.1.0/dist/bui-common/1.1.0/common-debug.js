define("bui-common/1.1.0/common-debug", ["jquery"], function(require, exports, module) {
  var BUI = require("bui-common/1.1.0/src/util-debug");
  BUI.mix(BUI, {
    UA: require("bui-common/1.1.0/src/ua-debug"),
    JSON: require("bui-common/1.1.0/src/json-debug"),
    Date: require("bui-common/1.1.0/src/date-debug"),
    Array: require("bui-common/1.1.0/src/array-debug"),
    KeyCode: require("bui-common/1.1.0/src/keycode-debug"),
    Observable: require("bui-common/1.1.0/src/observable-debug"),
    Base: require("bui-common/1.1.0/src/base-debug"),
    Component: require("bui-common/1.1.0/src/component/component-debug")
  });
  module.exports = BUI;
});
define("bui-common/1.1.0/src/util-debug", ["jquery"], function(require, exports, module) {
  /**
   * @class BUI
...
define("bui-common/1.1.0/src/ua-debug", ["jquery"], function(require, exports, module) {
  /**
...
define("bui-common/1.1.0/src/json-debug", ["jquery"], function(require, exports, module) {
  /**
...
define("bui-common/1.1.0/src/date-debug", [], function(require, exports, module) {
  /*
...
define("bui-common/1.1.0/src/array-debug", ["jquery"], function(require, exports, module) {
  /**
   * @fileOverview 数组帮助类
   * @ignore
   */
...
define("bui-common/1.1.0/src/keycode-debug", [], function(require, exports, module) {
  /**
   * @fileOverview 键盘值
   * @ignore
   */
...
define("bui-common/1.1.0/src/observable-debug", ["jquery"], function(require, exports, module) {
  /**
...
define("bui-common/1.1.0/src/base-debug", ["jquery"], function(require, exports, module) {
  /**
...
define("bui-common/1.1.0/src/component/component-debug", ["jquery"], function(require, exports, module) {
  /**
  ...
  var Component = {};
  BUI.mix(Component, {
    Manager: require("bui-common/1.1.0/src/component/manage-debug"),
    UIBase: require("bui-common/1.1.0/src/component/uibase/uibase-debug"),
    View: require("bui-common/1.1.0/src/component/view-debug"),
    Controller: require("bui-common/1.1.0/src/component/controller-debug")
  });
...
define("bui-common/1.1.0/src/component/manage-debug", ["jquery"], function(require, exports, module) {
  /**
...
define("bui-common/1.1.0/src/component/uibase/uibase-debug", ["jquery"], function(require, exports, module) {
  /**
   * @fileOverview uibase的入口文件
   * @ignore
   */
  var UIBase = require("bui-common/1.1.0/src/component/uibase/base-debug");
  BUI.mix(UIBase, {
    Align: require("bui-common/1.1.0/src/component/uibase/align-debug"),
    AutoShow: require("bui-common/1.1.0/src/component/uibase/autoshow-debug"),
    AutoHide: require("bui-common/1.1.0/src/component/uibase/autohide-debug"),
    Close: require("bui-common/1.1.0/src/component/uibase/close-debug"),
    Collapsable: require("bui-common/1.1.0/src/component/uibase/collapsable-debug"),
    Drag: require("bui-common/1.1.0/src/component/uibase/drag-debug"),
    KeyNav: require("bui-common/1.1.0/src/component/uibase/keynav-debug"),
    List: require("bui-common/1.1.0/src/component/uibase/list-debug"),
    ListItem: require("bui-common/1.1.0/src/component/uibase/listitem-debug"),
    Mask: require("bui-common/1.1.0/src/component/uibase/mask-debug"),
    Position: require("bui-common/1.1.0/src/component/uibase/position-debug"),
    Selection: require("bui-common/1.1.0/src/component/uibase/selection-debug"),
    StdMod: require("bui-common/1.1.0/src/component/uibase/stdmod-debug"),
    Decorate: require("bui-common/1.1.0/src/component/uibase/decorate-debug"),
    Tpl: require("bui-common/1.1.0/src/component/uibase/tpl-debug"),
    ChildCfg: require("bui-common/1.1.0/src/component/uibase/childcfg-debug"),
    Bindable: require("bui-common/1.1.0/src/component/uibase/bindable-debug"),
    Depends: require("bui-common/1.1.0/src/component/uibase/depends-debug")
  });
  BUI.mix(UIBase, {
...
define("bui-common/1.1.0/src/component/uibase/base-debug", ["jquery"], function(require, exports, module) {
  /**
   ...
   */
  var $ = require('jquery');
  var Manager = require("bui-common/1.1.0/src/component/manage-debug"),
    UI_SET = '_uiSet',
    ATTRS = 'ATTRS',
    ucfirst = BUI.ucfirst,
    noop = $.noop,
...
define("bui-common/1.1.0/src/component/uibase/align-debug", ["jquery"], function(require, exports, module) {
  /**
...
define("bui-common/1.1.0/src/component/uibase/autoshow-debug", ["jquery"], function(require, exports, module) {
  /**
...
define("bui-common/1.1.0/src/component/uibase/autohide-debug", ["jquery"], function(require, exports, module) {
  /**
...
define("bui-common/1.1.0/src/component/uibase/close-debug", ["jquery"], function(require, exports, module) {
  /**
...
define("bui-common/1.1.0/src/component/uibase/collapsable-debug", [], function(require, exports, module) {
  /**
...
define("bui-common/1.1.0/src/component/uibase/drag-debug", ["jquery"], function(require, exports, module) {
  /**
   * @fileOverview 拖拽
...
define("bui-common/1.1.0/src/component/uibase/keynav-debug", ["jquery"], function(require, exports, module) {
  /**
   * @fileOverview 使用键盘导航
   * @ignore
   */
...
define("bui-common/1.1.0/src/component/uibase/list-debug", ["jquery"], function(require, exports, module) {
  /**
...
define("bui-common/1.1.0/src/component/uibase/selection-debug", ["jquery"], function(require, exports, module) {
  /**
   * @fileOverview 单选或者多选
   * @author  dxq613@gmail.com
   * @ignore
...
define("bui-common/1.1.0/src/component/uibase/listitem-debug", [], function(require, exports, module) {
  /**
...
define("bui-common/1.1.0/src/component/uibase/mask-debug", ["jquery"], function(require, exports, module) {
  /**
...
define("bui-common/1.1.0/src/component/uibase/position-debug", ["jquery"], function(require, exports, module) {
  /**
...
define("bui-common/1.1.0/src/component/uibase/stdmod-debug", ["jquery"], function(require, exports, module) {
  /**
   * @fileOverview
...
define("bui-common/1.1.0/src/component/uibase/decorate-debug", ["jquery"], function(require, exports, module) {
  /**
...
define("bui-common/1.1.0/src/component/uibase/tpl-debug", ["jquery"], function(require, exports, module) {
  /**
   * @fileOverview 控件模板
   * @author dxq613@gmail.com
   * @ignore
...
define("bui-common/1.1.0/src/component/uibase/childcfg-debug", ["jquery"], function(require, exports, module) {
  /**
...
define("bui-common/1.1.0/src/component/uibase/bindable-debug", [], function(require, exports, module) {
  /**
...
define("bui-common/1.1.0/src/component/uibase/depends-debug", ["jquery"], function(require, exports, module) {
  /**
...
define("bui-common/1.1.0/src/component/view-debug", ["jquery"], function(require, exports, module) {
  /**
   * @fileOverview  控件的视图层
   * @author yiminghe@gmail.com
   * copied by dxq613@gmail.com
  ...
  var $ = require('jquery'),
    win = window,
    Manager = require("bui-common/1.1.0/src/component/manage-debug"),
    UIBase = require("bui-common/1.1.0/src/component/uibase/uibase-debug"), //BUI.Component.UIBase,
    doc = document;
  /**
   * 控件的视图层基类
...
define("bui-common/1.1.0/src/component/controller-debug", ["jquery"], function(require, exports, module) {
  /**
  ...
  var $ = require('jquery'),
    ...
    Manager = require("bui-common/1.1.0/src/component/manage-debug"),
    View = require("bui-common/1.1.0/src/component/view-debug"),
    Loader = require("bui-common/1.1.0/src/component/loader-debug"),
    wrapBehavior = BUI.wrapBehavior,
    getWrapBehavior = BUI.getWrapBehavior;
  /**
   * @ignore
...
define("bui-common/1.1.0/src/component/loader-debug", ["jquery"], function(require, exports, module) {
  /**
   * @fileOverview 加载控件内容
   * @ignore
   */
  'use strict';
  var $ = require('jquery'),
    BUI = require("bui-common/1.1.0/src/util-debug"),
    Base = require("bui-common/1.1.0/src/base-debug"),
    /**
